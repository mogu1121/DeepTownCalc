...
function displayMines (sortedMines) {
	...
	if (sortedMines.length === 0){
		resultDiv.innerHTML = "<p class='center'>没有材料可供开采</p>";
		sortedDiv.innerHTML = "<p class='center'>没有材料可供开采</p>";
	} else {
    ...
    // Click to sort mines by priority
		sortedDiv.innerHTML = "<p>点击按优先级排序</p>";
		sortedMines.sort(function(a, b){
